...
class DistillationLoss(nn.Module):
    ...
    def forward(self, student_logits, teacher_logits, targets):
        ...
        loss_kd = self.kl_div(student_log_probs, teacher_probs) * (self.temperature**2)
...
def main():
    ...
    if args.resume_checkpoint:
        ...
        # Map location to CPU first to avoid OOM during load? Or device.
    ...
    for epoch in range(100):
        for batch in dataloader:
            ...
            with autocast():
                ...
                # STUDENT PASS
                student_logits, _, _ = student(input_ids)
